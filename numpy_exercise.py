...
print("-----------------------------------------------   STEP ONE   -----------------------------------------------")
print("Total sales: " + "${:,.2f}".format((salesArray.sum())))
print()

## Step 2: What was Superstore's smallest and largest sale? Print them.
print("-----------------------------------------------   STEP TWO   -----------------------------------------------")
print("Smallest sale: " + "${:,.2f}".format((salesArray.min())))
print("Largest sale: " + "${:,.2f}".format((salesArray.max())))
print()
...
print("-----------------------------------------------   STEP FIVE  -----------------------------------------------")
print("Credit card fees for each register and store: ")
ccFees = salesArray * 0.02
print(ccFees)
print()
print("Total fees: " + "${:,.2f}".format((ccFees.sum())))
print()
...
print("-----------------------------------------------   STEP SIX  -----------------------------------------------")
print("Profit for each register and store after CC fees: ")
profit = salesArray - ccFees
print(profit)
print()
